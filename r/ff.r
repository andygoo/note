...
setwd('C:/Users/xwj/Desktop')
#总车源数
vehicle_source <- read.table('vehicle_source.csv', sep=',')
vehicle_source <- read.csv('vehicle_source.csv', head=F)
write.table(vehicle_source, file='ttt.txt', quote=F, sep="\t", row.names=F, col.names=F)
write.table(cd_vehicle_source, file='cd_vehicle_source.txt', quote=F, sep="\t", row.names=F, col.names=F)
head(vehicle_source)
nrow(vehicle_source)

#车源标价大于车三百最低价
vehicle_l <- vehicle_source[vehicle_source$V3>vehicle_source$V4,]
nrow(vehicle_l)
#车源标价大于车三百最高价
vehicle_h <- vehicle_source[vehicle_source$V3>vehicle_source$V5,]
nrow(vehicle_h)
#车源标价大于车三百最高价*1.08
vehicle_h108 <- vehicle_source[vehicle_source$V3>vehicle_source$V5*1.08,]
nrow(vehicle_h108)

#=========================================================

#成都重庆总车源数
cd_vehicle_source <- vehicle_source[vehicle_source$V2==45,]
cq_vehicle_source <- vehicle_source[vehicle_source$V2==15,]
cq_cd_vehicle_source <- rbind(cq_vehicle_source, cd_vehicle_source)
nrow(cq_cd_vehicle_source)

#成都重庆车源标价大于车三百最低价
cq_cq_l <- cq_cd_vehicle_source[cq_cd_vehicle_source$V3>cq_cd_vehicle_source$V4,]
nrow(cq_cq_l)
#成都重庆车源标价大于车三百最高价
cq_cq_h <- cq_cd_vehicle_source[cq_cd_vehicle_source$V3>cq_cd_vehicle_source$V5,]
nrow(cq_cq_h)
#成都重庆车源标价大于车三百最高价*1.08
cq_cq_h108 <- cq_cd_vehicle_source[cq_cd_vehicle_source$V3>cq_cd_vehicle_source$V5*1.08,]
nrow(cq_cq_h108)

#=========================================================

#北京郑州总车源数
bj_vehicle_source <- vehicle_source[vehicle_source$V2==12,]
zz_vehicle_source <- vehicle_source[vehicle_source$V2==103,]
bj_zz_vehicle_source <- rbind(bj_vehicle_source, zz_vehicle_source)
nrow(bj_zz_vehicle_source)

#=========================================================

#北京总车源数
bj_vehicle_source <- vehicle_source[vehicle_source$V2==12,]
nrow(bj_vehicle_source)

#北京车源标价大于车三百最低价
bj_l <- bj_vehicle_source[bj_vehicle_source$V3>bj_vehicle_source$V4,]
nrow(bj_l)
#北京车源标价大于车三百最高价
bj_h <- bj_vehicle_source[bj_vehicle_source$V3>bj_vehicle_source$V5,]
nrow(bj_h)
#北京车源标价大于车三百最高价*1.08
bj_h108 <- bj_vehicle_source[bj_vehicle_source$V3>bj_vehicle_source$V5*1.08,]
nrow(bj_h108)
...
#郑州总车源数
zz_vehicle_source <- vehicle_source[vehicle_source$V2==103,]
nrow(zz_vehicle_source)

#郑州车源标价大于车三百最低价
zz_l <- zz_vehicle_source[zz_vehicle_source$V3>zz_vehicle_source$V4,]
nrow(zz_l)
#郑州车源标价大于车三百最高价
zz_h <- zz_vehicle_source[zz_vehicle_source$V3>zz_vehicle_source$V5,]
nrow(zz_h)
#郑州车源标价大于车三百最高价*1.08
zz_h108 <- zz_vehicle_source[zz_vehicle_source$V3>zz_vehicle_source$V5*1.08,]
nrow(zz_h108)
...
bj_zz_vehicle_source <- vehicle_source[vehicle_source$V2==c(12,103),]
nrow(bj_zz_vehicle_source)
head(bj_zz_vehicle_source)


bj_vehicle_source <- vehicle_source[vehicle_source$V2==15,]
nrow(bj_vehicle_source)
head(bj_vehicle_source)
